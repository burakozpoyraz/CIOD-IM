%==========================================================================
% Burak Özpoyraz, 2020
% Figures of "Index Modulation Based CIOD for Secure Communications"
...
for SNRdB_index = 1 : len_SNRdB_array
    ...
    M = 4;
    mod_type = "PSK";
    [CIOD_N4_M4(3, SNRdB_index),...
     CIOD_N4_M4(4, SNRdB_index),...
     CIOD_N4_M4(5, SNRdB_index),...
     CIOD_N4_M4(6, SNRdB_index)] =...
    ...
    M = 4;
    mod_type = "PSK";
    [CIOD_N32_M4(3, SNRdB_index),...
     CIOD_N32_M4(4, SNRdB_index),...
     CIOD_N32_M4(5, SNRdB_index),...
     CIOD_N32_M4(6, SNRdB_index)] =...
    CIOD_IM_BER(num_iterations, N, M, P_tot_des, alpha, sigma2, SNRdB, mod_type);
    ...
    M = 16;
    mod_type = "QAM";
    [CIOD_N4_M16(3, SNRdB_index),...
     CIOD_N4_M16(4, SNRdB_index),...
     CIOD_N4_M16(5, SNRdB_index),...
     CIOD_N4_M16(6, SNRdB_index)] =...
    CIOD_IM_BER(num_iterations, N, M, P_tot_des, alpha, sigma2, SNRdB, mod_type);
    % /////////////////////////////////////////////////////////////////////
    ...
    M = 16;
    mod_type = "QAM";
    [CIOD_N32_M16(3, SNRdB_index),...
     CIOD_N32_M16(4, SNRdB_index),...
     CIOD_N32_M16(5, SNRdB_index),...
     CIOD_N32_M16(6, SNRdB_index)] =...
    CIOD_IM_BER(num_iterations, N, M, P_tot_des, alpha, sigma2, SNRdB, mod_type);
    % /////////////////////////////////////////////////////////////////////
...
CIOD_N8_M4(2, :) = [5e2 8e2 3e3 8e3 4e4 3e5 2e6 1e7 8e7 1e3 1e3];

eff_ala_M4 = zeros(6, len_SNRdB_array);
eff_ala_M4(1, :) = SNRdB_array;
eff_ala_M4(2, :) = [2e3 4e3 4e3 8e3 4e4 6e4 2e5 8e5 2e6 5e6 9e6];

conv_Na3_Nt2 = zeros(6, len_SNRdB_array);
conv_Na3_Nt2(1, :) = SNRdB_array;
conv_Na3_Nt2(2, :) = [2e3 4e3 5e3 8e3 3e4 4e4 5e4 1e5 4e5 6e5 9e5];

conv_Na6_Nt4 = zeros(6, len_SNRdB_array);
conv_Na6_Nt4(1, :) = SNRdB_array;
conv_Na6_Nt4(2, :) = [2e3 2e3 3e3 4e3 5e3 8e3 3e4 4e4 7e4 2e5 4e5];
...
for SNRdB_index = 1 : len_SNRdB_array
    ...
    alpha = 0.5;
    TAS_type = "SLNR";
    [conv_Na3_Nt2(3, SNRdB_index),...
     conv_Na3_Nt2(4, SNRdB_index),...
     conv_Na3_Nt2(5, SNRdB_index),...
     conv_Na3_Nt2(6, SNRdB_index)] =...
    ...
    alpha = 0.5;
    TAS_type = "SLNR";
    [conv_Na6_Nt4(3, SNRdB_index),...
     conv_Na6_Nt4(4, SNRdB_index),...
     conv_Na6_Nt4(5, SNRdB_index),...
     conv_Na6_Nt4(6, SNRdB_index)] =...
    ConventionalBER(num_iterations, Na, Nt, M, P_tot_des, alpha, SNRdB, TAS_type);
    % /////////////////////////////////////////////////////////////////////
    ...
    P_tot_des = 1;
    alpha = 0.5;
    [eff_ala_M4(3, SNRdB_index),...
     eff_ala_M4(4, SNRdB_index),...
     eff_ala_M4(5, SNRdB_index),...
     eff_ala_M4(6, SNRdB_index)] =...
    ...
    sigma2 = 0;
    mod_type = "PSK";
    [CIOD_N8_M4(3, SNRdB_index),...
     CIOD_N8_M4(4, SNRdB_index),...
     CIOD_N8_M4(5, SNRdB_index),...
     CIOD_N8_M4(6, SNRdB_index)] =...
    CIOD_IM_BER(num_iterations, N, M, P_tot_des, alpha, sigma2, SNRdB, mod_type);
    % /////////////////////////////////////////////////////////////////////
...
CIOD_0(2, :) = [7e2 2e3 2e4 5e5 5e6 5e7 7e2];

CIOD_003 = zeros(6, len_SNRdB_array);
CIOD_003(1, :) = SNRdB_array;
CIOD_003(2, :) = [5e2 3e3 3e3 6e3 8e3 8e3 9e3];

CIOD_01 = zeros(6, len_SNRdB_array);
CIOD_01(1, :) = SNRdB_array;
CIOD_01(2, :) = [5e2 7e2 9e2 2e3 3e3 3e3 3e3];
...
for SNRdB_index = 1 : len_SNRdB_array
    ...
    sigma2 = 0;
    [CIOD_0(3, SNRdB_index),...
     CIOD_0(4, SNRdB_index),...
     CIOD_0(5, SNRdB_index),...
     CIOD_0(6, SNRdB_index)] =...
    CIOD_IM_BER(num_iterations, N, M, P_tot_des, theta, sigma2, SNRdB, mod_type);
    % /////////////////////////////////////////////////////////////////////
    ...
    sigma2 = 0.03;    
    [CIOD_003(3, SNRdB_index),...
     CIOD_003(4, SNRdB_index),...
     CIOD_003(5, SNRdB_index),...
     CIOD_003(6, SNRdB_index)] =...
    CIOD_IM_BER(num_iterations, N, M, P_tot_des, theta, sigma2, SNRdB, mod_type);
    % /////////////////////////////////////////////////////////////////////
    ...
    sigma2 = 0.1;
    [CIOD_01(3, SNRdB_index),...
     CIOD_01(4, SNRdB_index),...
     CIOD_01(5, SNRdB_index),...
     CIOD_01(6, SNRdB_index)] =...
    CIOD_IM_BER(num_iterations, N, M, P_tot_des, theta, sigma2, SNRdB, mod_type);
    % /////////////////////////////////////////////////////////////////////
...
for SNRdB_index = 1 : len_SNRdB_array
    ...
    fprintf("Alpha = 0.1 \n");
    alpha = 0.1;
    [CIOD_01_Sec(2, SNRdB_index), CIOD_01_Sec(3, SNRdB_index), CIOD_01_Sec(4, SNRdB_index)] =...
    ...
    fprintf("Alpha = 0.5 \n");
    alpha = 0.5;
    [CIOD_05_Sec(2, SNRdB_index), CIOD_05_Sec(3, SNRdB_index), CIOD_05_Sec(4, SNRdB_index)] =...
        CIOD_IM_Secrecy(num_iterations, N, M, P_tot_des, alpha, sigma2, SNRdB, mod_type);
    % /////////////////////////////////////////////////////////////////////
    ...
    fprintf("Alpha = 0.9 \n");
    alpha = 0.9;
    [CIOD_09_Sec(2, SNRdB_index), CIOD_09_Sec(3, SNRdB_index), CIOD_09_Sec(4, SNRdB_index)] =...
        CIOD_IM_Secrecy(num_iterations, N, M, P_tot_des, alpha, sigma2, SNRdB, mod_type);
    % /////////////////////////////////////////////////////////////////////
...
for SNRdB_index = 1 : len_SNRdB_array
    ...
    alpha = 0.5;
    TAS_type = "SLNR";
    [conv_Na3_Nt2_Sec(2, SNRdB_index),...
     conv_Na3_Nt2_Sec(3, SNRdB_index),...
     conv_Na3_Nt2_Sec(4, SNRdB_index)] =...
    ...
    P_tot_des = 1;
    alpha = 0.5;
    [eff_ala_M4_Sec(2, SNRdB_index),...
     eff_ala_M4_Sec(3, SNRdB_index),...
     eff_ala_M4_Sec(4, SNRdB_index)] =...
    ...
    sigma2 = 0;
    mod_type = "PSK";
    [CIOD_N8_M4_Sec(2, SNRdB_index),...
     CIOD_N8_M4_Sec(3, SNRdB_index),...
     CIOD_N8_M4_Sec(4, SNRdB_index)] =...
    CIOD_IM_Secrecy(num_iterations, N, M, P_tot_des, alpha, sigma2, SNRdB, mod_type);
    % /////////////////////////////////////////////////////////////////////
